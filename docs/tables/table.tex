...
\hline
\rowcolor[RGB]{0,88,147} \textbf{Problemas:  } & \textbf{p} &\textbf{Resultado Python (1) }& \textbf{Resultado ''a mano''(2)} & \textbf{Calculadora Online}(3) & \textbf{Error entre (1) y (2)} &  \textbf{Error entre (1) y (3)} \\ \hline
...
\end{center}
\caption{Tabla de resultados y c\'alculo de errores.}
\label{tab:1}
\end{table}
